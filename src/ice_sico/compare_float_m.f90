...
module compare_float_m
  ...
  interface approx_equal
     procedure :: approx_equal_sp, approx_equal_dp
  end interface

  interface approx_equal_integer
     procedure :: approx_equal_integer_sp, approx_equal_integer_dp
  end interface

  interface approx_integer_multiple
     procedure :: approx_integer_multiple_sp, approx_integer_multiple_dp
  end interface
